...
return res.status(404).send('Project with the ID is not found in database')
  } catch (error) {
    return res.status(500).send(error.message)
  }
}
const createProject = async (req, res) => {
  try {
    ...
    // creating new project , saving it to var but using it later since the var has been created but not used yet
